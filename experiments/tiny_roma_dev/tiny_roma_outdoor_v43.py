...
def train(args):
    ...
    parameters = [
        {"params": model.xfeat.parameters(), "lr": roma.STEP_SIZE * 5e-6 / 8},
        {"params": model.coarse_matcher.parameters(), "lr": roma.STEP_SIZE * 1e-4 / 8},
        {"params": model.fine_matcher.parameters(), "lr": roma.STEP_SIZE * 1e-4 / 8},
    ]
