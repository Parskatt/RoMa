...
class XFeatModel(nn.Module):
    ...
    def pos_embed(self, corr_volume):
        ...
        corrs, inds = corr_volume.reshape(B,H1*W1, H0, W0).max(dim=1) # B, HW, H, W
    ...
    def forward(self, batch):
        ...
        corresps[8] = {"corr_volume": corr_volume, "gm_flow": coarse_matches[:,:2], "gm_certainty": coarse_matches[:,2:]}
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("tiny_roma_outdoor_v23_latest.pth")["model"])
